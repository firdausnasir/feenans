...
class UpdateBudgetData extends BaseInputData
{
    public function __construct(
        ...
        #[FromRouteParameter('budget')] public Budget $budget,
        #[FromAuthenticatedUser] public User $user,
    ) {}

    public static function normalizers(): array
    {
        return [UpdateBudgetRequestNormalizer::class, ...parent::normalizers()];
    }
...
class UpdateBudgetRequestNormalizer implements Normalizer
{
