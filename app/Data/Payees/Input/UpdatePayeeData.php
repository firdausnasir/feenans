...
class UpdatePayeeData extends BaseInputData
{
    public function __construct(
        public string $name,
        #[FromRouteParameter('ledger')] public Ledger $ledger,
        #[FromRouteParameter('payee')] public Payee $payee,
        #[FromAuthenticatedUser] public User $user,
    ) {}

    public static function normalizers(): array
    {
        return [UpdatePayeeRequestNormalizer::class, ...parent::normalizers()];
    }
...
class UpdatePayeeRequestNormalizer implements Normalizer
{
