...
export default function CreateBill() {
    ...
    const { data: accountsResult, loading: accountsLoading } = useApiQuery<{
        data: Account[];
    }>(`${base}/accounts`, { params: { visible: true } });
    const { data: categoriesResult, loading: categoriesLoading } =
    ...
    const lookupLoading = accountsLoading || categoriesLoading || payeesLoading;
    ...
    // Set default account_id when accounts load
        ...
        try {
            await api.post(`${base}/bills`, {
                body: {
                    ...
                    end_after_occurrences:
                        data.end_after_occurrences || null,
                },
            });
