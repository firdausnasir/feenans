...
function amountPrefix(type: 'expense' | 'income' | 'transfer'): string {
    switch (type) {
        case 'expense':
            return '-';
        case 'income':
...
export function TransactionCard({
    ...
    return (
        <div
            className={cn(
                'group flex rounded-lg border transition-colors',
                selected
        ...
        >
            ...
            {selectable && (
                <button
                    type="button"
                    className="flex w-12 shrink-0 items-center justify-center border-r border-border sm:w-14"
                    ...
                    <div className="flex shrink-0 items-center gap-1.5">
                        <span
                            className={cn(
                                ...
                                amountColorClass(transaction.transaction_type),
                            )}
                        >
            ...
            {/* Click to edit overlay (for non-selectable cards) */}
            {editUrl && !selectable && (
                <Link
                    href={editUrl}
